...
### Созданая инфраструктура

![Созданая инфраструктура](screenshots/yc.png)

### Выполнение DAG

![Выполнение DAG](screenshots/dag_run.png)

### Результат запуска MlFlow 

![Результат запуска MlFlow](screenshots/mlflow_run.png)

### Метрики MlFlow 

![Метрики MlFlow](screenshots/mlflow_metrics.png)

### Модель в MlFlow 

![Модель в MlFlow](screenshots/mlflow_model.png)

### Лог обучения

![Лог обучения](screenshots/train_log.png)
