...
S3_INPUT_DATA_BUCKET = f'{S3_BUCKET_NAME}/airflow/'
...
with DAG(
    ...
    start_date=datetime(year=2025, month=12, day=19),
    ...
    # 3 Запуск задания PySpark
    poke_spark_processing = DataprocCreatePysparkJobOperator(
        task_id='dp-cluster-pyspark-task',
        main_python_file_uri=f's3a://{S3_SRC_BUCKET}/src/data_cleaner.py',
        connection_id=YC_SA_CONNECTION.conn_id,
        args=[
